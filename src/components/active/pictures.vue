  ...
  <div>
    ...
    <div style="display: flex;flex-wrap:wrap ;">
      <div
        ...
        style="margin-right: 10px;position: relative;width: 130px;height: 130px;"
      >
        <img :src="item.img" alt style="width: 130px;height: 130px;" />
        <div
          style="position: absolute;width:100%;height: 100%;background: rgba(0,0,0,0.5); top:0;left:0; display: flex;
