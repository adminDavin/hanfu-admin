  ...
  data() {
    return {
      init: {
        ...
        // 插件-实现插入图片等功能
        plugins:
                    'link lists image code table colorpicker textcolor wordcount contextmenu indent2em lineheight nonbreaking preview uploadImg autoresize',
        // 工具栏-根据自己需要增减功能
        toolbar:
                    'bold italic underline strikethrough | fontsizeselect | forecolor backcolor | alignleft aligncenter alignright alignjustify | bullist numlist | indent2em lineheight nonbreaking | undo redo | image code | removeformat preview | fontselect uploadImg',
        branding: false,
        font_formats:
